...
def generate_launch_description():
	...
	slam_x3_gmapping_launch = IncludeLaunchDescription(PythonLaunchDescriptionSource([os.path.join(get_package_share_directory('slam_gmapping'), 'launch'),'/slam_x3_gmapping.launch.py']),condition=LaunchConfigurationNotEquals('lidar_type', 'x3'))
